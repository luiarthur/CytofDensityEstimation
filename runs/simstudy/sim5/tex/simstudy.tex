...
\begin{figure}[t!]
  \centering
  \begin{tabular}{cc}
    \includegraphics[scale=.45]{results/scenario1/postpred.pdf} &
    \includegraphics[scale=.45]{results/scenario2/postpred.pdf} \\
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/scenario3/postpred.pdf} &
    \includegraphics[scale=.45]{results/scenario4/postpred.pdf} \\
    (c) Scenario III &
    (d) Scenario IV
  \end{tabular}
...
\begin{figure}[t!]
  \centering
  \begin{tabular}{cc}
    \includegraphics[scale=.45]{results/scenario1/postpred-true-data-density.pdf} &
    \includegraphics[scale=.45]{results/scenario2/postpred-true-data-density.pdf} \\
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/scenario3/postpred-true-data-density.pdf} &
    \includegraphics[scale=.45]{results/scenario4/postpred-true-data-density.pdf} \\
    (c) Scenario III &
    (d) Scenario IV
  \end{tabular}
  \caption{Posterior predictive density in each simulation scenario for
...
\begin{figure}[t!]
  ...
  \begin{tabular}{cc}
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/scenario1/gammas.pdf} &
    \includegraphics[scale=.45]{results/scenario2/gammas.pdf} \\
    (c) Scenario III &
    (d) Scenario IV \\
    \includegraphics[scale=.45]{results/scenario3/gammas.pdf} &
    \includegraphics[scale=.45]{results/scenario4/gammas.pdf}
  \end{tabular}
