...
under the four scenarios. Note that scenario I and II 
\begin{table}
  \centering
...
\begin{figure}[t!]
  ...
  \begin{tabular}{cc}
    ...
    \includegraphics[scale=0.5]{results/K6/scenario1/m0/img/data-hist.pdf} &
    \includegraphics[scale=0.5]{results/K6/scenario2/m0/img/data-hist.pdf} \\
    (c) Scenario I & (d) Scenario II \\
    \includegraphics[scale=0.5]{results/K6/scenario3/m0/img/data-hist.pdf} &
    \includegraphics[scale=0.5]{results/K6/scenario4/m0/img/data-hist.pdf}
  \end{tabular}
\end{figure}
%
