...
\begin{figure}[t!]
  \centering
  \begin{tabular}{cc}
    \includegraphics[scale=.45]{results/K4/scenario1/img/postpred.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario2/img/postpred.pdf} \\
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/K4/scenario3/img/postpred.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario4/img/postpred.pdf} \\
    (c) Scenario III &
    (d) Scenario IV
  \end{tabular}
...
\begin{figure}[t!]
  \centering
  \begin{tabular}{cc}
    \includegraphics[scale=.45]{results/K4/scenario1/img/postpred-true-data-density.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario2/img/postpred-true-data-density.pdf} \\
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/K4/scenario3/img/postpred-true-data-density.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario4/img/postpred-true-data-density.pdf} \\
    (c) Scenario III &
    (d) Scenario IV
  \end{tabular}
  \caption{Posterior predictive density in each simulation scenario for
...
\begin{figure}[t!]
  ...
  \begin{tabular}{cc}
    (a) Scenario I &
    (b) Scenario II \\
    \includegraphics[scale=.45]{results/K4/scenario1/img/gammas.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario2/img/gammas.pdf} \\
    (c) Scenario III &
    (d) Scenario IV \\
    \includegraphics[scale=.45]{results/K4/scenario3/img/gammas.pdf} &
    \includegraphics[scale=.45]{results/K4/scenario4/img/gammas.pdf}
  \end{tabular}
