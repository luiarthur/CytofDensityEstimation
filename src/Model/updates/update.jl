...
include("update_tau.jl")
include("update_psi.jl")
include("update_v.jl")
include("update_zeta.jl")
include("update_sigma.jl")
...
function update_state!(state::State, data::Data, prior::Prior, tuners::Tuners;
  ...
  # NOTE: If v and zeta are marginalized over in the updates of lambda,
  # then they must be updated immediately after updating lambda.
